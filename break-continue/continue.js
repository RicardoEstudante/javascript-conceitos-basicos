...
* a partir da proxima iteração (ao contrario do break, o continue não encerra a execução completa)
 */
...
for (let i = 0; i < 5; i++) { // declarando um for para iterar até o 9
    if (i >= 2 && i < 4){ // criando uma condição no qual a variável i seja maior do que 1 e menor do que 4 (2,3)
