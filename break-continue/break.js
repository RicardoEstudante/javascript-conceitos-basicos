...
*
* quando o break é usado sem uma label, ele encerra o bloco de código mais interno que
...
switch (teste) {
    ...
    case 2:
        console.log("esse código também vai ser executado");
        break;  //a execução vai passar por aqui e vai encerrar o switch, pois o break encerra a instrução

    case 3:
        console.log("esse código tbm não vai ser executado");
